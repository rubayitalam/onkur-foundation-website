...
const defaultWhyCards = [
  ...
  },
  {
    ...
    desc_en: "Collateral-free microloans.",
  },
  {
    icon: "PiggyBank",
    ...
    desc_en: "Savings with 6% annual interest.",
  },
  {
    icon: "HeartHandshake",
    ...
    desc_en: "Credit insurance coverage.",
  },
];
...
const defaultSteps = [
  {
    ...
    desc_bn: "সহজ ফর্ম পূরণ করে আবেদন করুন।",
    desc_en: "Fill out a simple application.",
  },
  {
    step_num: 2,
    title_bn: "মাঠপর্যায়ে যাচাই",
    title_en: "On-Ground Verification",
    desc_bn: "মাঠ কর্মকর্তা দ্বারা যাচাই।",
    desc_en: "Verification by field officer.",
  },
  {
    step_num: 3,
    title_bn: "কমিটি অনুমোদন",
    title_en: "Committee Approval",
    desc_bn: "ঋণ কমিটির অনুমোদন।",
    desc_en: "Approval by localized committee.",
  },
  {
    step_num: 4,
    title_bn: "ঋণ বিতরণ",
    title_en: "Disbursement",
    desc_bn: "সরাসরি অথবা এমএফএস-এ বিতরণ।",
    desc_en: "Disbursed directly or via MFS.",
  },
];
...
const defaultApproachPoints = [
  {
    ...
    desc_bn: "মাঠ কর্মকর্তা দ্বারা সরেজমিনে যাচাই।",
    desc_en: "Verification by field officers.",
  },
  {
    icon: "Users",
    ...
    desc_en: "Monitored by community groups.",
  },
  {
    icon: "TrendingUp",
    title_bn: "ধারাবাহিক তদারকি ও প্রবৃদ্ধি",
    title_en: "Ongoing Support & Monitoring",
    desc_bn: "নিয়মিত পরামর্শ ও ব্যবসায়িক দিকনির্দেশনা।",
    desc_en: "Weekly tracking and business advice.",
  },
];
...
const defaultServices = {
  ...
  intro_bn:
    "অঙ্কুর ফাউন্ডেশন মাইক্রোক্রেডিট রেগুলেটরি অথরিটি (MRA)-র নির্দেশনা অনুসরণ করে দুই ধরনের ঋণ প্রোডাক্ট পরিচালনা করে। নিচে প্রতিটি প্রোডাক্টের বিস্তারিত শর্তাবলি দেওয়া হলো।",
  intro_en:
    "Onkur Foundation operates two loan products under the guidance of the Microcredit Regulatory Authority (MRA). Full terms for each product are detailed below.",
  items: [
    {
      title_bn: "ক্ষুদ্র (নারী) ঋণ",
      title_en: "Small (Women's) Loan",
      short_desc_bn:
        "সমিতি-ভিত্তিক সাপ্তাহিক ঋণ, একচেটিয়াভাবে আয়বর্ধক কাজে নিয়োজিত নারীদের জন্য।",
      short_desc_en:
        "A committee-based weekly loan program exclusively for women engaged in income-generating work.",
      full_desc_bn:
        "ক্ষুদ্র (নারী) ঋণ হলো অঙ্কুর ফাউন্ডেশনের মূল ক্ষুদ্রঋণ কর্মসূচি, যা সমিতি-ভিত্তিক পদ্ধতিতে পরিচালিত হয়। এই ঋণ শুধুমাত্র আয়বর্ধক কাজে নিয়োজিত নারীদের জন্য প্রযোজ্য। সদস্যপদের জন্য বয়স ১৮-৬০ বছরের মধ্যে হতে হবে এবং শারীরিক ও মানসিকভাবে সুস্থ থাকতে হবে, এবং শাখার কর্ম এলাকায় স্থায়ীভাবে বসবাস করতে হবে। ভর্তি ফি ১০ টাকা (অফেরতযোগ্য, শুধুমাত্র নতুন ও ফেরত আসা সদস্যদের জন্য)। প্রতিটি সমিতিতে ন্যূনতম ১০ জন এবং সর্বোচ্চ ৩০ জন সদস্য থাকে, যাঁর মধ্যে ১ জন সভানেত্রী, ১ জন সেক্রেটারি ও ১ জন ক্যাশিয়ার নির্বাচিত হন।",
      full_desc_en:
        "The Small (Women's) Loan is Onkur Foundation's core microcredit program, operated through a committee-based (samity) system. It is available exclusively to women engaged in income-generating activities. Members must be between 18-60 years old, physically and mentally fit, and permanently reside within the branch's operating area. The admission fee is BDT 10 (non-refundable, applicable to new and returning members only). Each committee has a minimum of 10 and a maximum of 30 members, with one chairperson, one secretary, and one cashier elected from among the members.",
      loan_range_bn:
        "প্রথম দফা ২০,০০০ - ৫০,০০০ টাকা। সর্বোচ্চ সিলিং ১,০০,০০০ টাকা (সরেজমিনে যাচাই ও সদস্যের সক্ষমতার ভিত্তিতে)। ঋণের পরিমাণ হাজারে রাউন্ড ফিগারে হবে।",
      loan_range_en:
        "First phase BDT 20,000 - 50,000. Maximum ceiling BDT 100,000 (based on field verification and member capacity). Loan amounts are rounded to the nearest thousand.",
      tenure_bn:
        "১ বছর (৪৬ সপ্তাহ)। সাপ্তাহিক কিস্তি প্রতি হাজারে ২৫ টাকা। ক্রমহ্রাসমান সার্ভিস চার্জ হার বার্ষিক ২২%।",
      tenure_en:
        "1 year (46 weeks). Weekly installment BDT 25 per thousand. Declining service charge rate of 22% annually.",
      icon: "Sprout",
      image_url: "",
    },
    {
      ...
      short_desc_bn:
        "নারী ও পুরুষ উভয়ের জন্য উন্মুক্ত, ব্যবসা সম্প্রসারণ ও উদ্যোক্তা উন্নয়নের জন্য ডিজাইন করা ঋণ।",
      short_desc_en:
        "Open to both men and women, designed for business expansion and entrepreneurship development.",
      full_desc_bn:
        "ক্ষুদ্র ব্যবসা ও উদ্যোক্তা ঋণ আয়বর্ধক কাজে নিয়োজিত নারী ও পুরুষ উভয়ের জন্য উন্মুক্ত। এই প্রোডাক্টে সমিতি-ভিত্তিক অথবা এককভাবে (উদ্যোক্তা-ভিত্তিক) ঋণ নেওয়া যায়, এবং সাপ্তাহিক বা মাসিক কিস্তিতে পরিশোধ করা যায়। আবেদনকারীর অবশ্যই দৃশ্যমান ও বৈধ ব্যবসা বা প্রকল্প থাকতে হবে। ৫০,০০০ টাকা বা তদূর্ধ্ব ঋণ বিতরণের ক্ষেত্রে অতিরিক্ত ডকুমেন্টেশন (নন-জুডিশিয়াল স্ট্যাম্পে অঙ্গীকারনামা, দুইজন জামিনদার) প্রয়োজন হয়।",
      full_desc_en:
        "The Small Business & Entrepreneur Loan is open to both men and women engaged in income-generating activities. This product can be taken on a committee basis or individually (entrepreneur-based), with weekly or monthly repayment options. Applicants must have a visible and legitimate business or project. Loans of BDT 50,000 or above require additional documentation (a non-judicial stamp declaration and two guarantors).",
      loan_range_bn:
        "প্রথম দফা ৫০,০০০ - ২,০০,০০০ টাকা। সর্বোচ্চ সিলিং ১৫,০০,০০০ টাকা (সরেজমিনে যাচাই ও সদস্যের সক্ষমতার ভিত্তিতে)। প্রথম দফা ১,০০,০০০ টাকার বেশি ঋণ বৃদ্ধির ক্ষেত্রে প্রধান কার্যালয়ের পূর্বানুমোদন প্রয়োজন।",
      loan_range_en:
        "First phase BDT 50,000 - 200,000. Maximum ceiling BDT 1,500,000 (based on field verification and member capacity). Increases beyond BDT 100,000 in subsequent phases require head office pre-approval.",
      tenure_bn:
        "১ বছর। সাপ্তাহিক কিস্তি প্রতি হাজারে ২৫ টাকা অথবা মাসিক প্রতি হাজারে ৯৫ টাকা। ক্রমহ্রাসমান সার্ভিস চার্জ হার বার্ষিক ২২%।",
      tenure_en:
        "1 year. Weekly installment BDT 25 per thousand, or monthly BDT 95 per thousand. Declining service charge rate of 22% annually.",
      icon: "TrendingUp",
      image_url: "",
    },
  ],
  ...
  shared_benefits: [
    {
      ...
      desc_bn:
        "সাপ্তাহিক সর্বোচ্চ ৩০ টাকা বা মাসিক ১০০ টাকা পর্যন্ত সঞ্চয় জমা রাখা যায়। ঋণ থাকাকালীন মূল ঋণের ১০% এর অতিরিক্ত সঞ্চয় রাউন্ড ফিগারে উত্তোলনযোগ্য। সঞ্চয় স্থিতির উপর বার্ষিক ৬% হারে সুদ প্রদান করা হয়।",
      desc_en:
        "Members can save up to BDT 30 weekly or BDT 100 monthly. Any savings beyond 10% of the outstanding loan can be withdrawn in round figures. An annual interest rate of 6% is paid on the savings balance.",
    },
    {
      title_bn: "ঋণ বীমা ও সুবিধাদি",
      title_en: "Loan Insurance & Benefits",
      desc_bn:
        "প্রতি ঋণগ্রহীতাকে গৃহীত (আসল) ঋণের ০.৫% বা হাজারে ৫ টাকা প্রিমিয়াম জমা দিতে হয়। নিয়মিত ঋণগ্রহীতার মৃত্যু বা প্রমাণিত স্থায়ী অক্ষমতার ক্ষেত্রে অবশিষ্ট ঋণ মওকুফ করা হয় এবং নমিনিকে দাফন-কাফন বাবদ ১০,০০০ টাকা প্রদান করা হয়।",
      desc_en:
        "Each borrower pays a premium of 0.5% (or BDT 5 per thousand) of the principal loan received. In case of death or proven permanent disability of a regular borrower, the remaining loan is waived and BDT 10,000 is provided to the nominee for funeral expenses.",
    },
    {
      title_bn: "জামানতবিহীন ঋণ",
      title_en: "Collateral-Free",
      desc_bn:
        "কোনো জামানত বা স্থাবর সম্পত্তি ছাড়াই ঋণ প্রদান করা হয়। শুধুমাত্র একজন জামিনদার (১৮-৬০ বছর বয়সী, শারীরিক ও মানসিকভাবে সুস্থ) প্রয়োজন হয়।",
      desc_en:
        "Loans are provided without any collateral or immovable property. Only one guarantor (aged 18-60, physically and mentally fit) is required.",
    },
    {
      title_bn: "অগ্রিম কিস্তি সুবিধা",
      title_en: "Advance Installment Facility",
      desc_bn:
        "মেয়াদ পূর্তির পূর্বে সর্বশেষ ৫টি কিস্তি পর্যন্ত অগ্রিম পরিশোধ করা যায়, যার উপর সার্ভিস চার্জ মওকুফ পাওয়া যায়।",
      desc_en:
        "Borrowers can pay up to the last 5 installments in advance before maturity, with the corresponding service charge waived.",
    },
  ],
...
export default function AdminDashboardPage() {
  ...
  const [eligibilityPoints, setEligibilityPoints] = useState<any>({
    bn: "",
    en: "",
  });
  ...
  const [activeTeamMember, setActiveTeamMember] = useState<any>({
    id: "",
    name_bn: "",
    name_en: "",
    role_bn: "",
  ...
  const [activeTestimonial, setActiveTestimonial] = useState<any>({
    id: "",
    name_bn: "",
    name_en: "",
    location_bn: "",
  ...
  const [homeBullets, setHomeBullets] = useState({
    mission_bn: "",
    mission_en: "",
    vision_bn: "",
    vision_en: "",
  ...
  const [careerSubTab, setCareerSubTab] = useState<"postings" | "applications">(
    "postings",
  );
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (checkingAuth || dbLoading) {
        setLoadError(
          "Database loading is taking longer than expected. You can force access if authenticated.",
        );
      }
    }, 5000);
  ...
  useEffect(() => {
    ...
    const unsubHome = onValue(
      ...
      (snap) => {
        ...
        setHomeData(data);
        setHomeBullets({
          mission_bn: (data.mission_bullets || [])
            .map((b: any) => b.text_bn)
            .join("\n"),
          mission_en: (data.mission_bullets || [])
            .map((b: any) => b.text_en)
            .join("\n"),
          vision_bn: (data.vision_bullets || [])
            .map((b: any) => b.text_bn)
            .join("\n"),
          vision_en: (data.vision_bullets || [])
            .map((b: any) => b.text_en)
            .join("\n"),
          values_bn: (data.values_bullets || [])
            .map((b: any) => b.text_bn)
            .join("\n"),
          values_en: (data.values_bullets || [])
            .map((b: any) => b.text_en)
            .join("\n"),
        });
    ...
    const unsubTeamContent = onValue(
      teamContentRef,
      (snap) => {
    ...
    const unsubBlogContent = onValue(
      blogContentRef,
      (snap) => {
    ...
    const unsubLoanApps = onValue(
      loanAppsRef,
      (snap) => {
        const val = snap.val() || {};
        setLoanApplicationsList(
          Object.keys(val)
            .map((k) => ({ id: k, ...val[k] }))
            .sort(
              (a, b) =>
  ...
  const saveHome = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const mission_bullets = homeBullets.mission_bn
        .split("\n")
        .filter((l) => l.trim())
        .map((l, i) => ({
          text_bn: l,
      ...
      const vision_bullets = homeBullets.vision_bn
        .split("\n")
        .filter((l) => l.trim())
        .map((l, i) => ({
          text_bn: l,
      ...
      const values_bullets = homeBullets.values_bn
        .split("\n")
        .filter((l) => l.trim())
        .map((l, i) => ({
          text_bn: l,
  ...
  const saveServices = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...servicesData,
        eligibility_points_bn: (eligibilityPoints.bn || "")
          .split("\n")
          .map((line: string) => line.trim())
          .filter(Boolean),
        eligibility_points_en: (eligibilityPoints.en || "")
          .split("\n")
          .map((line: string) => line.trim())
          .filter(Boolean),
      };
  ...
  const handleSeedDefaultContent = async () => {
    if (
      confirm(
        "Are you sure you want to seed default data? This overwrites site content nodes.",
      )
    ) {
      try {
        setSaving(true);
        ...
        {loadError ? (
          <div className="max-w-md bg-white p-8 rounded-3xl border border-secondary/10 shadow-lg space-y-4">
            ...
            <p className="text-xs text-text font-light leading-relaxed">
              If this is the first deployment, database nodes might be
              completely unseeded. You can force access to trigger seeding.
            </p>
            <div className="pt-2">
              <button
                type="button"
          ...
          <>
            ...
            <p className="text-xs tracking-wider text-text">
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="flex justify-between items-center border-b border-secondary/10 pb-4">
            <div>
              ...
              <p className="text-xs text-text font-light mt-1">
                Configure bilingual settings and database components in
                real-time.
              </p>
            </div>
            ...
            <div className="space-y-12">
              <form onSubmit={saveHome} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        হোমপেজের ওপরে বড় ব্যানার শিরোনাম হিসেবে প্রদর্শিত হবে।
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        Appears as the large heading in the hero banner of the
                        homepage.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setHomeData({
                            ...homeData,
                            hero_subtitle_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        হোমপেজ ব্যানারের শিরোনামের ঠিক নিচে প্রদর্শিত
                        প্যারগ্রাফ।
                      </p>
                    </div>
                    <div className="space-y-1">
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        Appears underneath the main title text in the hero
                        banner.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 pt-2">
                    <label className="text-xs font-semibold text-text block">
                      Why Choose Us Cards (Fixed 4 Cards)
                    </label>
                    <div className="grid grid-cols-1 gap-6">
                      {(whyCards.length > 0 ? whyCards : defaultWhyCards).map(
                        (card, idx) => (
                          <div
                            key={idx}
                            className="p-4 bg-white rounded-xl border border-secondary/10 space-y-3"
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                              ...
                              >
                                <option value="ShieldCheck">
                                  ShieldCheck (Transparency)
                                </option>
                                <option value="Coins">
                                  Coins (Collateral-Free)
                                </option>
                                <option value="PiggyBank">
                                  PiggyBank (Savings)
                                </option>
                                <option value="HeartHandshake">
                                  HeartHandshake (Credit Insurance)
                                </option>
                              </select>
                            </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setHomeData({
                            ...homeData,
                            process_title_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setHomeData({
                            ...homeData,
                            process_title_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                copy[idx] = {
                                  ...copy[idx],
                                  step_num: Number(e.target.value),
                                };
                                setProcessSteps(copy);
                              }}
                              className="px-3 py-2 border border-gray-200 rounded-lg text-xs"
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setHomeBullets({
                            ...homeBullets,
                            vision_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-xs font-mono"
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        প্রতি লাইনে ১টি করে স্বপ্ন বুলেট পয়েন্ট (বাংলা)।
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Values Bullets (Bangla)
                      </label>
                      <textarea
                        rows={6}
                        ...
                        onChange={(e) =>
                          setHomeBullets({
                            ...homeBullets,
                            values_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-xs font-mono"
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        প্রতি লাইনে ১টি করে মূল্যবোধ বুলেট (বাংলা)।
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-text">
                      Mission/Vision/Values Section Image URL
                    </label>
                    <input
                      type="url"
                      required
                      ...
                      onChange={(e) =>
                        setHomeData({
                          ...homeData,
                          mission_image_url: e.target.value,
                        })
                      }
                      className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                    />
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Appears next to the Mission/Vision/Values tabs on the
                      homepage.
                    </p>
                  </div>
                </div>
              ...
              <div className="border-t border-secondary/10 pt-10 space-y-6">
                ...
                <form
                  ...
                  className="bg-white p-6 rounded-2xl border border-secondary/10 space-y-4"
                >
                  <h4 className="text-xs font-bold text-secondary">
                    {activeTestimonial.id
                      ? "Edit Testimonial Profile"
                      : "Add Testimonial Profile"}
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      type="text"
                      required
                      placeholder="Borrower Name (Bangla)"
                    ...
                    <input
                      type="text"
                      required
                      placeholder="Borrower Name (English)"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <input
                      type="text"
                      required
                      placeholder="Location (Bangla) e.g. নরসিংদী"
                      value={activeTestimonial.location_bn || ""}
                      onChange={(e) =>
                        setActiveTestimonial({
                          ...activeTestimonial,
                          location_bn: e.target.value,
                        })
                      }
                      className="px-3 py-2 bg-white border border-secondary/10 rounded-lg text-xs"
                    />
                  ...
                  <input
                    type="url"
                    required
                    placeholder="Avatar Image URL (Unsplash/Static link)"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <textarea
                      rows={3}
                      required
                      placeholder="Quote (Bangla)"
                      value={activeTestimonial.quote_bn || ""}
                      onChange={(e) =>
                        setActiveTestimonial({
                          ...activeTestimonial,
                          quote_bn: e.target.value,
                        })
                      }
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="border border-gray-200 text-gray-700 px-4 py-2 rounded-lg text-xs hover:bg-gray-50 cursor-pointer"
                    >
                      Clear Form
                    </button>
                  </div>
                  ...
                  {testimonialsList.map((t) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-bold text-secondary">
                            {tContent(t.name_bn, t.name_en)}
                          </p>
                          <p className="text-[10px] text-gray-500 font-light">
                            {tContent(t.location_bn, t.location_en)}
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-1">
                        <button
                          ...
                          className="text-primary hover:bg-primary/5 p-2 rounded-md transition-colors"
                        >
              ...
              <form onSubmit={saveAbout} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Operational Approach Text (Bangla)
                      </label>
                      <textarea
                        rows={3}
                        required
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Operational Approach Text (English)
                      </label>
                      <textarea
                        rows={3}
                        required
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Appears as the illustration photo in the Our Journey
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {(approachPoints.length > 0
                      ...
                      >
                        <p className="text-xs font-bold text-secondary">
                          Approach Point #{idx + 1}
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          <input
                            type="text"
                            required
                            placeholder="Heading (Bangla)"
                            value={pt.title_bn}
                            onChange={(e) => {
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_name_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_name_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_title_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_title_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_message_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-xs"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setAboutData({
                            ...aboutData,
                            chairman_message_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-xs"
                      />
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAboutData({
                          ...aboutData,
                          chairman_image_url: e.target.value,
                        })
                      }
                      className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                    />
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Appears as the round avatar picture next to the Chairman's
                      message statement quote block.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {timelineItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="p-4 bg-white rounded-xl border border-gray-200 relative space-y-3"
                      >
                        <button
                          type="button"
                          onClick={() =>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <input
                            type="text"
                            required
                            placeholder="Year (Bangla) e.g. ২০১৮"
                            value={item.year}
                            onChange={(e) => {
                          ...
                          <input
                            type="text"
                            required
                            placeholder="Year (English) e.g. 2018"
                            value={item.year_en}
                            onChange={(e) => {
                              const copy = [...timelineItems];
                              copy[idx] = {
                                ...copy[idx],
                                year_en: e.target.value,
                              };
                              setTimelineItems(copy);
                            }}
                            className="px-3 py-1.5 border border-gray-200 rounded-lg text-xs"
              ...
              <form onSubmit={saveServices} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Introduction Description (Bangla)
                      </label>
                      <textarea
                        rows={3}
                        required
                  ...
                  {(servicesData.items || []).map(
                    (product: any, idx: number) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="p-6 bg-white rounded-2xl border border-gray-200 space-y-4"
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateProductField("title_bn", e.target.value)
                                }
                            ...
                            <div className="space-y-1">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateProductField("title_en", e.target.value)
                                }
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs"
                              />
                            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-gray-500 uppercase">
                                Tenure & Repayment Policy (Bangla)
                              </label>
                              <textarea
                                rows={2}
                                required
                            ...
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-gray-500 uppercase">
                                Tenure & Repayment Policy (English)
                              </label>
                              <textarea
                                rows={2}
                                required
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setServicesData({
                            ...servicesData,
                            shared_benefits_heading_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setServicesData({
                            ...servicesData,
                            shared_benefits_heading_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {(servicesData.shared_benefits || []).map(
                      (benefit: any, idx: number) => {
                        const updateBenefitField = (
                          ...
                          setServicesData({
                            ...servicesData,
                            shared_benefits: updatedBenefits,
                          });
                        };
                          ...
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <input
                                type="text"
                                required
                                placeholder="Benefit Title (Bangla)"
                                value={benefit.title_bn || ""}
                                onChange={(e) =>
                                  updateBenefitField("title_bn", e.target.value)
                                }
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs"
                              />
                              <input
                                ...
                                onChange={(e) =>
                                  updateBenefitField("title_en", e.target.value)
                                }
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs"
                              />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <textarea
                                rows={2}
                                required
                                placeholder="Benefit Description (Bangla)"
                                value={benefit.desc_bn || ""}
                                onChange={(e) =>
                                  updateBenefitField("desc_bn", e.target.value)
                                }
                              ...
                              <textarea
                                ...
                                onChange={(e) =>
                                  updateBenefitField("desc_en", e.target.value)
                                }
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs font-mono"
                              />
                            </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setServicesData({
                            ...servicesData,
                            eligibility_heading_bn: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setServicesData({
                            ...servicesData,
                            eligibility_heading_en: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        প্রতি লাইনে ১টি করে বুলেটের শর্ত লিখুন (বাংলা)।
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Checklist Bullets (English)
                      </label>
                      <textarea
                        rows={6}
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        Enter one point per line for english conditions.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {activeSection === "team" && (
            <div className="space-y-12">
              ...
              <form
                onSubmit={saveTeamLanding}
                className="bg-white p-6 rounded-2xl border border-secondary/10 space-y-6"
              >
                <h3 className="text-sm font-bold uppercase tracking-wider text-primary border-b border-secondary/10 pb-2">
                  Team Landing Copy
                </h3>
                ...
                <div className="space-y-1">
                  ...
                  />
                  <p className="text-[10px] text-gray-500 mt-0.5">
                    Appears as the header banner image above the team grid on
                    the live site.
                  </p>
                </div>
              ...
              <div className="space-y-6 pt-4 border-t border-secondary/10">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <input
                      type="text"
                      required
                      placeholder="Role (Bangla) e.g. সভাপতি"
                      value={activeTeamMember.role_bn || ""}
                      onChange={(e) =>
                        setActiveTeamMember({
                          ...activeTeamMember,
                          role_bn: e.target.value,
                        })
                      }
                      className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs"
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <textarea
                      rows={3}
                      placeholder="Biography (Bangla)"
                      value={activeTeamMember.bio_bn || ""}
                      onChange={(e) =>
                        setActiveTeamMember({
                          ...activeTeamMember,
                          bio_bn: e.target.value,
                        })
                      }
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {teamList.map((m) => (
                    <div
                      key={m.id}
                      className="p-4 bg-white border border-gray-200 rounded-xl flex items-center justify-between shadow-xs"
                    >
                      <div className="flex items-center gap-3">
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  />
                  <p className="text-[10px] text-gray-500 mt-0.5">
                    Appears as the header banner image above the blog listing
                    intro on the live site.
                  </p>
                </div>
              ...
              <div className="space-y-6 pt-4 border-t border-secondary/10">
                ...
                >
                  <h4 className="text-xs font-bold text-secondary">
                    {activeBlog.id ? "Edit Blog Article" : "Write Blog Article"}
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <input
                      ...
                      onChange={(e) =>
                        setActiveBlog({ ...activeBlog, slug: e.target.value })
                      }
                      className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        setActiveBlog({ ...activeBlog, author: e.target.value })
                      }
                      className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs"
                    />
                    <select
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <textarea
                      rows={3}
                      required
                      placeholder="Excerpt Summary (Bangla)"
                      value={activeBlog.excerpt_bn || ""}
                      onChange={(e) =>
                        setActiveBlog({
                          ...activeBlog,
                          excerpt_bn: e.target.value,
                        })
                      }
                      className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs w-full"
                    />
                    <textarea
                      rows={3}
                      required
                      placeholder="Excerpt Summary (English)"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <textarea
                      rows={6}
                      required
                      placeholder="Full Body Content (Bangla)"
                      value={activeBlog.content_bn || ""}
                      onChange={(e) =>
                        setActiveBlog({
                          ...activeBlog,
                          content_bn: e.target.value,
                        })
                      }
                    ...
                    <textarea
                      rows={6}
                      required
                      placeholder="Full Body Content (English)"
                      ...
                      <div className="flex items-center gap-3">
                        {post.coverImageUrl && (
                          <img
                            ...
                            alt=""
                            className="w-16 h-10 object-cover rounded-md shrink-0 bg-gray-100"
                          />
                        )}
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            {post.category && (
                              <span className="bg-gray-100 text-[8px] font-bold px-1.5 py-0.5 rounded text-gray-600 uppercase">
                                {post.category}
                              </span>
                            )}
                          </div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  />
                  <p className="text-[10px] text-gray-500 mt-0.5">
                    Appears as the large header banner image at the top of the
                    Careers page.
                  </p>
                </div>
                <button
              ...
              {careerSubTab === "postings" && (
                <div className="space-y-8 animate-fadeIn">
                  ...
                  >
                    <h4 className="text-xs font-bold text-secondary">
                      {activeJob.id ? "Edit Job Posting" : "Add Job Posting"}
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <input
                        type="text"
                        required
                        placeholder="Job Title (Bangla)"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <input
                        type="text"
                        required
                        placeholder="Department (Bangla)"
                        value={activeJob.department_bn || ""}
                        onChange={(e) =>
                          setActiveJob({
                            ...activeJob,
                            department_bn: e.target.value,
                          })
                        }
                        className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs"
                      />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <input
                        type="text"
                        required
                        placeholder="Job Type (Bangla) e.g. পূর্ণকালীন"
                        value={activeJob.type_bn || ""}
                        onChange={(e) =>
                          setActiveJob({
                            ...activeJob,
                            type_bn: e.target.value,
                          })
                        }
                        className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs"
                      />
                      <input
                        type="text"
                        required
                        placeholder="Job Type (English) e.g. Full-time"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <textarea
                        rows={3}
                        required
                        placeholder="Requirements (Bangla)"
                        value={activeJob.requirements_bn || ""}
                        onChange={(e) =>
                          setActiveJob({
                            ...activeJob,
                            requirements_bn: e.target.value,
                          })
                        }
                        className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs w-full"
                      />
                      <textarea
                        ...
                        onChange={(e) =>
                          setActiveJob({
                            ...activeJob,
                            requirements_en: e.target.value,
                          })
                        }
                        className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs w-full"
                      />
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <label
                        htmlFor="jobActive"
                        className="text-xs font-semibold text-text select-none"
                      >
                        Show Posting Publicly
                      </label>
                    </div>
                        ...
                        >
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={`text-[8px] font-bold px-1.5 py-0.5 rounded uppercase ${job.isActive ? "bg-green-50 text-green-700" : "bg-red-50 text-red-600"}`}
                              >
              ...
              {careerSubTab === "applications" && (
                <div className="space-y-6 animate-fadeIn">
                  <h4 className="text-xs font-bold text-secondary uppercase tracking-wider">
                    Submitted Applications (Sorted by Date)
                  </h4>
                      ...
                      {applicationsList.map((app) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              onClick={() =>
                                setViewingApp(isExpanded ? null : app)
                              }
                              ...
                              <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-gray-500 font-light">
                                  ...
                                  <span className="font-semibold text-gray-700">
                                    {tContent(app.jobTitle_bn, app.jobTitle_en)}
                                  </span>{" "}
                                  • Phone: {app.phone}
                                </p>
                              </div>
                                      ...
                                      <tbody>
                                        {(app.education || []).map(
                                          (ed: any, i: number) => (
                                            <tr
                                              key={i}
                                              className="border-b border-gray-100 last:border-0 text-[11px]"
                                            >
                                ...
                                <div className="space-y-2">
                                  ...
                                  {app.isFirstJob ? (
                                    <p className="text-gray-500 font-light italic">
                                      Applicant's first job (no prior experience
                                      entries).
                                    </p>
                                  ) : (
                                    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div className="flex justify-between items-center border-b border-secondary/10 pb-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-light mt-1">
                    Realtime applications submitted by borrowers via the
                    Services page online form.
                  </p>
                </div>
              </div>
              ...
              {loanApplicationsList.length === 0 ? (
                <div className="bg-white p-12 rounded-3xl border border-secondary/10 text-center space-y-3">
                  ...
                  <p className="text-xs text-gray-500 max-w-sm mx-auto">
                    When visitors submit loan requests on the Services page
                    modal, their applications will appear here automatically.
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 gap-4">
                  {loanApplicationsList.map((app) => {
                    ...
                    return (
                      <div
                        key={app.id}
                        className="bg-white border border-secondary/10 rounded-2xl shadow-xs overflow-hidden"
                      >
                        <div
                          onClick={() =>
                            setViewingLoanApp(isExpanded ? null : app)
                          }
                ...
                <div className="space-y-4 bg-white p-6 rounded-2xl border border-secondary/10">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {contactDepts.map((dept, idx) => (
                      <div
                        key={idx}
                        className="p-4 bg-gray-50 rounded-xl relative border border-gray-200 space-y-3"
                      >
                        <button
                          type="button"
                          onClick={() =>
                            setContactDepts(
                              contactDepts.filter((_, i) => i !== idx),
                            )
                          }
                          className="absolute top-3 right-3 text-red-500 hover:text-red-700 cursor-pointer"
                        >
          ...
          {activeSection === "settings" && (
            <div className="space-y-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        অফিসের মূল ফোন নম্বর, যা হেডার ও ফুটারে প্রদর্শিত হবে।
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                      ...
                      <input
                        ...
                        required
                        value={
                          settingsData.phone_general || settingsData.phone || ""
                        }
                        onChange={(e) =>
                          setSettingsData({
                            ...settingsData,
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        type="text"
                        required
                        value={settingsData.phone_field_operations || ""}
                        onChange={(e) =>
                          setSettingsData({
                            ...settingsData,
                            phone_field_operations: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 bg-white border border-secondary/10 rounded-lg text-sm"
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        অফিসের ইমেইল অ্যাড্রেস, যা ফুটারে প্রদর্শিত হবে।
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Physical Office Address (Bangla)
                      </label>
                      <textarea
                        rows={2}
                        required
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        অফিসের পূর্ণ ঠিকানা (বাংলা)।
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-text">
                        Physical Office Address (English)
                      </label>
                      <textarea
                        rows={2}
                        required
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-0.5">
                        Physical office address used for text display and Google
                        Map coordinates query.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      ফুটারে দেওয়া ফেসবুক পেজের লিংক।
                    </p>
                  </div>
                </div>
              ...
              <div className="border-t border-secondary/10 pt-10 space-y-6">
                ...
                >
                  <h4 className="text-xs font-bold text-secondary">
                    {activeFaq.id ? "Edit Question" : "Add Question"}
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      type="text"
                ...
                <div className="space-y-4 pt-4">
                  {faqList.map((f) => (
                    ...
                    >
                      <div>
                        <p className="text-xs font-bold text-secondary">
                          {tContent(f.question_bn, f.question_en)}
                        </p>
                        <p className="text-[10px] text-gray-500 font-light mt-0.5">
                          Display Order: {f.order || 1}
                        </p>
                      </div>
                      <div className="flex gap-1">
                        <button
