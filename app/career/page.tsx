...
export default function CareerPage() {
  ...
  return (
    <div className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      {/* 2. Job Listings Grid */}
      {jobs.length === 0 ? (
        <div className="text-center max-w-md mx-auto p-12 bg-white rounded-3xl border border-secondary/10 shadow-sm space-y-4">
          <Briefcase className="w-12 h-12 text-text mx-auto" />
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {jobs.map((job) => {
            ...
            return (
              <div 
                key={job.id} 
                className="bg-white rounded-2xl border border-secondary/10 shadow-xs overflow-hidden transition-all duration-300 hover:shadow-md"
              >
                {/* Header Card Area */}
                <div 
                ...
                >
                  <div className="space-y-3">
                    <span className="inline-block bg-white/5 text-secondary text-xs font-semibold px-2.5 py-1 rounded-md">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-text font-normal">
                ...
                <AnimatePresence>
                  {isExpanded && (
                    <motion.div
                      ...
                      animate={{ height: "auto" }}
                      exit={{ height: 0 }}
                      className="overflow-hidden border-t border-secondary/10 bg-white"
                    >
                      <div className="p-6 sm:p-8 space-y-6">
                        <div className="space-y-2.5">
                          <h4 className="font-bold text-sm text-secondary uppercase tracking-wider">
                            {tContent("কাজের বিবরণী (Job Description)", "Job Description")}
                          </h4>
                          <p className="text-sm text-text font-normal leading-relaxed whitespace-pre-wrap">
                        ...
                        <div className="pt-4 border-t border-secondary/10 flex justify-end">
                          <button
                            ...
                            className="bg-primary hover:opacity-90 text-white px-6 py-3 rounded-lg text-xs font-semibold shadow-sm hover:shadow transition-all cursor-pointer"
                          >
        ...
        {applyingJob && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl border border-secondary/10 w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]"
            >
              {/* Modal Header */}
              <div className="bg-white text-text px-6 py-5 flex items-center justify-between">
              ...
              <div className="flex-1 overflow-y-auto p-6 sm:p-8">
                {success ? (
                  <div className="text-center py-12 space-y-6 max-w-md mx-auto">
                    <div className="w-16 h-16 bg-white/5 text-primary rounded-full flex items-center justify-center mx-auto border border-primary animate-bounce">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={handleCloseModal}
                        className="bg-white text-white px-6 py-2.5 rounded-lg text-xs font-semibold hover:bg-gray-100 transition-all cursor-pointer"
                      >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <h4 className="font-bold text-sm text-secondary border-b border-secondary/10 pb-2">
                        {tContent("ব্যক্তিগত বিবরণী (Personal Info)", "Personal Information")}
                      </h4>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-text">{tContent("পূর্ণ নাম", "Full Name")} *</label>
                          <input
                            type="text"
                            required
                            value={fullName}
                            onChange={(e) => setFullName(e.target.value)}
                            className="w-full px-3 py-2 border border-secondary/10 rounded-lg text-sm bg-white focus:outline-[#1F4A3D]"
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-text">{tContent("মোবাইল নম্বর", "Phone Number")} *</label>
                          <input
                            type="tel"
                            required
                            value={phone}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-text">{tContent("ইমেইল ঠিকানা", "Email Address")} *</label>
                          <input
                            type="email"
                            required
                            value={email}
                        ...
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-text">{tContent("বর্তমান ঠিকানা", "Present Address")} *</label>
                          <input
                            type="text"
                            required
                            value={address}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-secondary/10 pb-2">
                        ...
                        <button
                          ...
                          className="text-primary hover:text-[#b04f24] text-xs font-semibold flex items-center gap-1 cursor-pointer"
                        >
                      ...
                      {education.map((ed, idx) => (
                        <div key={idx} className="p-4 bg-white rounded-xl border border-secondary/10 space-y-3 relative">
                          {education.length > 1 && (
                            <button
                              type="button"
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("পরীক্ষা / ডিগ্রীর নাম", "Degree / Exam")}</label>
                              <input
                                type="text"
                                required
                                value={ed.degree}
                                ...
                                className="w-full px-3 py-1.5 border border-secondary/10 rounded-lg text-xs focus:outline-[#1F4A3D]"
                              />
                            </div>
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("শিক্ষা প্রতিষ্ঠান", "Institution")}</label>
                              <input
                                type="text"
                                required
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("পাশের সাল", "Passing Year")}</label>
                              <input
                                type="number"
                                required
                                value={ed.year}
                            ...
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("ফলাফল (জিপিএ / বিভাগ)", "Result / GPA")}</label>
                              <input
                                type="text"
                                required
                                value={ed.result}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-secondary/10 pb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <label className="inline-flex items-center gap-1.5 text-xs text-text select-none cursor-pointer">
                            <input
                              type="checkbox"
                              checked={isFirstJob}
                              onChange={(e) => setIsFirstJob(e.target.checked)}
                              className="rounded border-secondary/10 text-secondary"
                            />
                      ...
                      {!isFirstJob && experience.map((exp, idx) => (
                        <div key={idx} className="p-4 bg-white rounded-xl border border-secondary/10 space-y-3 relative animate-fadeIn">
                          {experience.length > 1 && (
                            <button
                              type="button"
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("প্রতিষ্ঠানের নাম", "Company / Organization")}</label>
                              <input
                                type="text"
                                required
                            ...
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("পদবী", "Position")}</label>
                              <input
                                type="text"
                                required
                                value={exp.position}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="space-y-1">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("সময়কাল (যেমন: ৬ মাস)", "Duration")}</label>
                              <input
                                type="text"
                                required
                                value={exp.duration}
                            ...
                            <div className="space-y-1 sm:col-span-2">
                              <label className="text-[10px] font-bold text-text uppercase tracking-wider">{tContent("দায়িত্বসমূহ", "Key Responsibilities")}</label>
                              <input
                                type="text"
                                required
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-semibold text-text">{tContent("কভার লেটার / আবেদন বার্তা", "Cover Letter / Message")} *</label>
                        <textarea
                          rows={4}
                          required
                          value={coverLetter}
                          onChange={(e) => setCoverLetter(e.target.value)}
                          className="w-full px-3 py-2 border border-secondary/10 rounded-lg text-sm bg-white focus:outline-[#1F4A3D] w-full"
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-secondary/10">
                      <button
                        type="button"
                        onClick={handleCloseModal}
                        className="border border-secondary/10 text-secondary px-5 py-2.5 rounded-lg text-xs font-semibold hover:bg-secondary/5 cursor-pointer"
                      >
                      ...
                      <button
                        type="submit"
                        disabled={submitting}
                        className="bg-white hover:bg-gray-100 text-white px-6 py-2.5 rounded-lg text-xs font-semibold disabled:bg-gray-400 cursor-pointer flex items-center gap-1.5"
                      >
                        {submitting ? (
                          <>
